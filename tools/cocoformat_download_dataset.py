...
def main(local_dataset_dir):
    ...
    remote_dataset_url = "https://huggingface.co/datasets/testdummyvt/cocohumanparts/resolve/main"
    ...
    labels_train_url = remote_dataset_url + "/person_humanparts_train2017_coco_format.json"
    ...
    current_train_json_file = local_dataset_dir +"/"+ "person_humanparts_train2017_coco_format.json"
    current_valid_json_file = local_dataset_dir +"/"+ "person_humanparts_val2017_coco_format.json"

    new_train_json_file = local_dataset_dir +"/"+ "train" +"/"+ "_annotations.coco.json"
    new_valid_json_file = local_dataset_dir +"/"+ "valid" +"/"+ "_annotations.coco.json"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--local_dataset_dir', type=str, default='.',
