...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Process data folder based on format type.')
    parser.add_argument('datafolder', type=str, help='Path to the data folder')
    parser.add_argument('format_type', type=str, choices=['coco', 'yolo'], help='Format type: coco or yolo')
