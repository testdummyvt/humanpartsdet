...
def main(local_dataset_dir):
    ...
    download([labels_train_url, labels_val_url], local_dataset_dir + os.sep + "labels", threads=2)
    ...
    download([images_train_url, images_val_url], local_dataset_dir + os.sep + "images", threads=2)
