...
if __name__ == "__main__":
    ...
    ultralytics_root = "/home/ubuntu/data/cocohumanparts"  # Replace with your ultralytics folder
    ...
    for split, target_split in zip(splits, target_splits):
        ...
        for src_image_path in glob(image_dir + os.sep + "*.*"):
            ...
            dst_image_path = src_image_path.replace(os.sep + "images", "").replace(ultralytics_root, target_root).replace(split, target_split)
